...
export function buildDeckIntelligence(matches, historyRecords, nowSeconds=Math.floor(Date.now()/1000)) {
  ...
  const archetypes=[[/Science Fiction|Sci-Fi/i,'Future Seeker'],[/Thriller|Mystery|Crime/i,'Tension Cartographer'],[/Comedy/i,'Joy Curator'],[/Horror/i,'Midnight Explorer'],[/Documentary/i,'Reality Decoder'],[/Animation|Family/i,'Wonder Collector'],[/Drama|Romance/i,'Human Storyteller'],[/Action|Adventure/i,'Momentum Chaser']];
