...
import { friendlyConnectionError } from './connection-error-server.js';
import { commandDeck } from './command-deck-server.js';
import { streamTelemetry, peopleTelemetry } from './telemetry-server.js';
...
import { createAutomationEngine } from './automation-server.js';
import { universalSearch, answerCompanion, companionNotifications } from './companion-server.js';
...
import { createOptimizationStore } from './optimization-store-server.js';
import { clearOptimizationHistory, optimizationEta, optimizationSummary, updateQueuedJob } from './optimization-queue-server.js';
