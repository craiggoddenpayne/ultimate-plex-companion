  ...
  const items = [
    {
      ...
      addedAt: now - 86400,
      Media: [
        { videoResolution: '4k', videoCodec: 'hevc', videoDynamicRange: 'HDR', bitrate: 20000, Part: [{ size: 1000 }] },
        { videoResolution: '1080', videoCodec: 'h264', Part: [{ size: 500 }] },
      ],
    },
    {
      ratingKey: '2',
      ...
      Genre: [],
      addedAt: now - 86400,
      Media: [{ videoResolution: '1080', videoCodec: 'h264', bitrate: 8000, Part: [{ size: 700 }] }],
    },
  ];
